<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\phpStudy\WWW\zxw/application/admin/index\view\company\index.html";i:1490263562;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
    ...
    <div>
      ...
      <div class="chuangti">
        <table class="culture">
          <tr>
            <td>公司名称：</td>
            <td><input id="name" type="text" name="culture[name]" value="<?php echo $culture['name']; ?>"></td>
          </tr>
          <tr>
            <td>公司描述：</td>
            <td>
              <textarea cols="100" name="culture[content]" rows="25" id="dotF8hRx"><?php echo $culture['content']; ?></textarea>
          ...
          <tr>
            <td>类型：</td>
            <td><input type="text" name="culture[type]" value="<?php echo $culture['type']; ?>" disabled="disabled"></td>
          </tr>
          <tr>
            <td></td>
            <td>
  ...
  <script type="text/javascript">
    function submit(){
      ...
      $form = "<form action='<?php echo url("Company/culture"); ?>' method='post' id='ajaxForm'></form>";
      $(".culture").wrap($form);
      $("#ajaxForm").submit();
    }
  </script>
